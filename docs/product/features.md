...
<!-- The product's declarative feature state, one list for every sub-project: the code is pulled
     ...
     at features by it. The heading is the feature in ≤200 chars; under it short `-` points only,
     holding what that line can't carry. Heading and points together stay within 300 chars — what
     will not fit is two features. Never prose, and never why a choice was made — that is
     decisions.md. -->
