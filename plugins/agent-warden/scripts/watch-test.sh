...
WARDEN_STATE="$T/b/state" WARDEN_ONLY='mycrew-crew:chief' bash "$here/watch.sh" "$T/b/tr" none 1 >"$T/b/out" 2>&1 & pid=$!
sleep 2
human "plain work nobody watches" >"$T/b/tr/cccccccc-1111-2222-3333-444444444444.jsonl"
{ human "run the product"
  echo '{"type":"agent-setting","agentSetting":"mycrew-crew:chief"}'
