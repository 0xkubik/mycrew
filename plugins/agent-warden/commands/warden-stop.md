---
description: "Put the watch down without ending the session — stop the eyes, keep the conversation and everything learned in it. Use it to work unobserved, or when the watch is in the way."
argument-hint: "[why it is being put down — or nothing]"
---

# /warden-stop — put the watch down, keep the session

The run ends with the eyes stopped, the session still there to talk to, and the gap on record.

- **Stop the eyes, never the session.** `TaskStop` the armed watch and leave everything else standing —
