...
The venue's template overrides it; popular texts (Habr and the like) are out of scope.
...
- **Introduce a term once,** in Russian with the Latin abbreviation in brackets, then keep it.
