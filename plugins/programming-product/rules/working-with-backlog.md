...
- **The lead moves the cards.** Move a task to in progress when dispatching it, to done only after verifying it against its acceptance criteria and accepting it. Specialists know nothing of the board and never touch a card.
