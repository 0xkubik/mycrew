...
- **Ground before you invent.** Read the North Star in the root `CLAUDE.md`, `docs/features.md`,
...
- **The ledger binds you.** A rejected idea is **never** re-pitched. The one exception: something
  ...
  naming exactly what changed. Read `docs/ideas/ideas.md` every run, before the first pitch.
...
- **Every verdict, both halves, always.** A verdict lands in **two** places: one line in
  `docs/ideas/ideas.md` and a full dossier at `docs/ideas/history/<slug>.md`. A
