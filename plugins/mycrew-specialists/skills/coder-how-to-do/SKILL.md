---
name: coder-how-to-do
kind: intent
description: "Settle a real implementation fork — a technical decision with materially different options and no obvious winner — into one buildable approach. Never a menu."
---

# coder-how-to-do — settle the fork, hand back one buildable approach

The run ends with one buildable approach and the named alternatives it beat — never a menu, and
never a line of code.

If the task is trivial and clear how — one obvious way to implement — skip this stage entirely and go
straight to `mycrew-specialists:coder-do`.
