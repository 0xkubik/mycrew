...
- **Significant design work goes to the designer, not to a worker.** A new surface, a new component, or
  a change to how something looks and behaves is `mycrew-specialists:designer`'s — dispatched exactly
  like a worker, with the same brief. Anything that changes the product's visual language rather than
  adding to it is the chief's to take to the human first.
